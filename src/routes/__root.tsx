  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <a href="/" className="mt-6 inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground">Go home</a>
      </div>
    </div>
  );
}
...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "MNM Travels — Premium Vehicle Rentals" },
      { name: "description", content: "Comfortable, safe, affordable car & tempo traveller rentals across India." },
    ],
    links: [
...
function RootComponent() {
  ...
  // Admin routes get their own layout (no public navbar/footer)
